  ...
  return (
    <div className="flex items-center justify-between h-16 px-4 md:px-6 lg:px-8">
      ...
      <div className="flex items-center gap-4">
        {/* Notifications */}
        <button className="relative p-2 hover:bg-slate-100 rounded-lg transition-colors" aria-label="Notificaciones">
          <Bell size={20} className="text-slate-600" aria-hidden="true" />
