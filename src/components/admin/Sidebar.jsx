...
const Sidebar = ({ onClose }) => {
  ...
  return (
    <div className="h-full flex flex-col dark:bg-slate-900">
      ...
      <div className="p-6 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h1 className="font-bold text-slate-900 dark:text-white">JM Gym</h1>
      ...
      {/* User Info & Logout */}
      <div className="p-4 border-t border-slate-200 space-y-3 dark:border-slate-700">
        <div className="px-4 py-3 bg-slate-50 rounded-xl dark:bg-slate-800">
          <p className="text-xs text-slate-600 dark:text-slate-400">Admin</p>
          <p className="font-medium text-slate-900 dark:text-white">{user?.name || 'Administrador'}</p>
        </div>
        <button
