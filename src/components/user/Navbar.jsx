...
function Navbar() {
  return (
    <header className="flex items-center justify-between gap-4 rounded-[28px] bg-white/85 px-4 py-2.5 shadow-[0_10px_30px_rgba(15,23,42,.06)] backdrop-blur sm:py-3">
      <Link to="/cliente/home" className="flex items-center gap-2 sm:gap-3">
        ...
        />
        <div>
          <strong className="block text-base font-black text-black sm:text-lg">JMGym</strong>
