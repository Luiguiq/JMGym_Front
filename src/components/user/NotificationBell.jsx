...
const typeColors = {
  ...
  RESERVA_CONFIRMADA: 'bg-sky-100 text-sky-700', RESERVA_CANCELADA: 'bg-slate-100 text-slate-700',
  ...
  return (
    <div ref={menuRef} className={floating ? '' : 'relative'}>
      ...
      >
        ...
        {unread > 0 && (
          <span className={`absolute flex items-center justify-center rounded-full bg-red-500 px-1 text-[10px] font-bold leading-none text-white shadow ${
