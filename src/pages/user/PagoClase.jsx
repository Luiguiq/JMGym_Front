...
function PagoClase() {
    ...
    return (
        <main className="min-h-screen bg-slate-50 font-sans pb-8 flex justify-center">
            <div className="w-full max-w-md bg-slate-50 min-h-screen relative flex flex-col">

                {/* Encabezado */}
                <header className="px-6 pt-10 pb-6 bg-slate-50">
                    <button
                        onClick={() => navigate(-1)}
                        className="flex items-center gap-3 text-slate-800 font-semibold transition hover:text-fuchsia-700"
                    >
                ...
                <div className="px-6 flex-1">
                    ...
                    <div className="bg-white rounded-[24px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-8 border border-slate-100">
                        <h2 className="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest mb-5">
                            Resumen de reserva
                        </h2>
                        ...
                        <div className="grid gap-4 text-sm">
                            ...
                            <div className="flex justify-between pt-2 items-center">
                                ...
                                <span className="font-extrabold text-fuchsia-800 text-xl">
                    ...
                    <div className="grid gap-4 mb-8">
                        ...
                        <button
                            ...
                            className={`flex items-center p-4 rounded-[20px] border-2 transition-all text-left ${
                                method === 'YAPE'
                                    ? 'border-fuchsia-700 bg-fuchsia-50/30'
                                    : 'border-white bg-white shadow-[0_4px_20px_rgb(0,0,0,0.03)]'
                            }`}
                        >
                            <div className="w-12 h-12 bg-fuchsia-700 rounded-xl flex items-center justify-center text-white font-bold text-2xl font-serif mr-4 shrink-0 shadow-sm">
                                y
                            </div>
                            ...
                            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${
                                method === 'YAPE' ? 'border-fuchsia-700 bg-fuchsia-700' : 'border-slate-200 bg-slate-50'
                            }`}>
                        ...
                        >
                            <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center text-xl mr-4 shrink-0">
                                💵
                            </div>
                            <div className="flex-1">
                            ...
                            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${
                                method === 'EFECTIVO' ? 'border-fuchsia-700 bg-fuchsia-700' : 'border-slate-200 bg-slate-50'
                            }`}>
                ...
                {/* Footer Area */}
                <div className="bg-slate-50 px-6 pb-8">
                    <div className="bg-fuchsia-50/70 border border-fuchsia-100 rounded-[20px] p-4 flex gap-4 mb-6 items-center">
                    ...
                    <button
                        ...
                        disabled={processing}
                        className="w-full bg-gradient-to-r from-fuchsia-700 to-pink-600 text-white font-bold text-lg py-4 rounded-[20px] shadow-lg shadow-fuchsia-200/50 transform hover:scale-[1.02] transition-all disabled:opacity-70 disabled:transform-none"
                    >
