      ...
      <div className="animate-page-enter">
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-7xl">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-primary-foreground/76">
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
            ...
            <div className="rounded-[38px] bg-card p-8 shadow-[0_24px_70px_rgba(7,17,31,.08)] lg:p-10">
        ...
        <section className="bg-[#07111f] px-5 py-20 text-primary-foreground lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-2">
            <article className="rounded-[38px] border border-primary-foreground/10 bg-primary-foreground/8 p-8 backdrop-blur lg:p-10">
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-3">
              {pillars.map((pillar) => (
                <article key={pillar.title} className="rounded-[34px] bg-card p-8 shadow-[0_18px_55px_rgba(7,17,31,.08)]">
                  <div className="mb-8 h-2 w-20 rounded-full bg-cyan-400" />
                  <h3 className="text-3xl font-black">{pillar.title}</h3>
                  <p className="mt-4 leading-7 text-secondary">{pillar.text}</p>
                </article>
              ))}
            </div>
          </div>
        ...
        <section className="px-5 pb-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[42px] bg-[#07111f] text-primary-foreground shadow-[0_28px_80px_rgba(7,17,31,.2)] lg:grid-cols-[.95fr_1.05fr]">
            <div className="p-8 lg:p-12">
              ...
              <p className="mt-6 max-w-xl leading-8 text-primary-foreground/70">
                Conoce nuestra sede o entra al sistema para reservar tu proximo entrenamiento.
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link to="/cliente/login" className="rounded-full bg-card px-7 py-4 text-center text-sm font-black uppercase tracking-[0.18em] text-foreground transition hover:bg-surface">
                  Ingresar cliente
                </Link>
                <Link to="/sede" className="rounded-full border border-primary-foreground/20 px-7 py-4 text-center text-sm font-black uppercase tracking-[0.18em] text-primary-foreground transition hover:border-cyan-200 hover:text-cyan-100">
                  Ver sede
                </Link>
              </div>
            </div>
