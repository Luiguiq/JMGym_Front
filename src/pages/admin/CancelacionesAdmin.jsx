            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <th className="text-left px-4 py-3 font-bold text-slate-600">Código</th>
                  <th className="text-left px-4 py-3 font-bold text-slate-600">Usuario</th>
                  <th className="text-left px-4 py-3 font-bold text-slate-600">Clase</th>
                  <th className="text-left px-4 py-3 font-bold text-slate-600">Motivo</th>
                  <th className="text-left px-4 py-3 font-bold text-slate-600">Cancelado por</th>
