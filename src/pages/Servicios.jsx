      ...
      <div className="animate-page-enter">
        ...
        >
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_.85fr] lg:items-end">
            ...
            <div className="rounded-[34px] border border-white/10 bg-white/8 p-7 backdrop-blur">
              ...
              <div className="grid gap-6">
                {services.map((service, index) => {
                  ...
                  return (
                    <article
                      key={service.title}
                      className="group relative overflow-hidden rounded-[34px] bg-white p-7 shadow-[0_18px_55px_rgba(7,17,31,.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_75px_rgba(7,17,31,.14)] md:ml-16 lg:p-8"
                    >
                      <div className="absolute inset-y-0 left-0 w-1 bg-cyan-300 opacity-0 transition group-hover:opacity-100" />
                      <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
                        ...
                        <div>
                          ...
                          <p className="mt-4 max-w-2xl leading-7 text-slate-600">{service.text}</p>
                        </div>
                      </div>
                    </article>
                  );
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-[30px] border border-white/10 bg-white/8 p-6">
                ...
                <p className="mt-3 text-sm leading-6 text-white/64">Organiza tu asistencia desde el sistema.</p>
              </div>
              <div className="rounded-[30px] bg-cyan-300 p-6 text-slate-950">
                <Dumbbell className="h-8 w-8" aria-hidden="true" />
                <p className="mt-5 text-xl font-black">Entrena</p>
                <p className="mt-3 text-sm leading-6 text-slate-800">Sigue un plan y participa en clases activas.</p>
              </div>
              <div className="rounded-[30px] border border-white/10 bg-white/8 p-6">
                <ArrowUpRight className="h-8 w-8 text-cyan-200" aria-hidden="true" />
                <p className="mt-5 text-xl font-black">Progresa</p>
                <p className="mt-3 text-sm leading-6 text-white/64">Ajusta habitos y vuelve por el siguiente reto.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[42px] bg-white shadow-[0_28px_80px_rgba(7,17,31,.12)] lg:grid-cols-[1fr_.9fr]">
            <div className="p-8 lg:p-12">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link to="/cliente/login" className="rounded-full bg-[#07111f] px-7 py-4 text-center text-sm font-black uppercase tracking-[0.18em] text-white transition hover:bg-brand-700">
                  Ingresar cliente
                </Link>
                <Link to="/sede" className="rounded-full border border-slate-200 px-7 py-4 text-center text-sm font-black uppercase tracking-[0.18em] text-slate-950 transition hover:border-brand-700 hover:text-brand-700">
                  Ver sede
                </Link>
              </div>
            </div>
